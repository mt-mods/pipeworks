...
for white  = 0, 1 do
	...
	local groups = {snappy = 3, tube = 1, tubedevice = 1, tube = 1, overheat = 1, dig_generic = 4, axey=1, handy=1, pickaxey=1}
...
minetest.register_node(BASENAME .. "_burnt", {
	...
	paramtype = "light",
	is_ground_content = false,
	groups = {snappy = 3, tube = 1, tubedevice = 1, tube = 1, not_in_creative_inventory=1, dig_generic = 4, axey=1, handy=1, pickaxey=1},
	_mcl_hardness=0.8,
	drop = BASENAME.."000000",
	sunlight_propagates = true,
	selection_box = selection_box,
